...
namespace E_recrutement.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(SD.Role_recruteur).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(SD.Role_recruteur)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(SD.Role_candidat)).GetAwaiter().GetResult();
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null, IFormFile file = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null && Input.Role == "Candidat")
                {
                    ...
                    string filePath = Path.Combine(wwwRootPath, @"CV");
